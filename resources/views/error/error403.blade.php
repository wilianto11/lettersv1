        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                ...
                <div class="text-center">
                    ...
                    <p class="fs-5 text-gray-600">Anda tidak diizinkan utuk mengakses halaman ini</p>
                    <a href="/dashboard" class="btn btn-lg btn-outline-primary mt-3">Kembali ke Dashboard</a>
                </div>
            </div>
        </div>
